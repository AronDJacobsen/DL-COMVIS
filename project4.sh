#!/bin/sh
#BSUB -J albertkjoller_efficientnet_v5
#BSUB -o /work3/s194253/02514/project4_results/sh_logs/albertkjoller_efficientnet_v5.out
#BSUB -e /work3/s194253/02514/project4_results/sh_errors/albertkjoller_efficientnet_v5.err
#BSUB -n 6
#BSUB -q gpua100
